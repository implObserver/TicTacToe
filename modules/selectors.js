...
const Selectors = (() => {
    ...
    const gpMainTitle = DomElements.gpBurgerMenu.querySelector('.game-page__burger__main-title');
    const gpScoreBoard = DomElements.gpBurgerMenu.querySelector('.game-page__burger__score-board');
    ...
    return { gpScoreBoard, gpMainTitle, gpOpenButton, gpCloseButton, gpWrapper, gpClosedBurger, gpOpenedBurger, gpScoresContainer, gpGameBoard };
})();
