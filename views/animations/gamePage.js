    ...
    const ForGamePage = (() => {
        const ForBurgerMenu = (() => {
            const open = (duration) => {
                ...
                UniversalAnimations.SmoothVisibility.close(GamePage.Body.timer, 1, 0, 200, 'forwards');
                UniversalAnimations.SmoothVisibility.close(GamePage.Body.displayTimer, 1, 0, 200, 'forwards');
                UniversalAnimations.SmoothVisibility.open(GamePage.Body.mobileTimer(), 0, 1, 200, 'forwards');
            ...
            const close = (duration) => {
                ...
                UniversalAnimations.SmoothVisibility.close(GamePage.Body.mobileTimer(), 1, 0, 200, 'forwards');
...
export { AnimationsPresets, GameBoard, Markers, Timer, UniversalAnimations };